...
class StaticTemplate extends Template {
    ...
    private final List<MergeRegion> mergeRegions = new java.util.ArrayList<MergeRegion>();
    ...
    public void setSelectList(List<Integer> selectList) {
        ...
        if (selectList != null) {
            ...
            parameterIndexMap = new java.util.LinkedHashMap<Integer, Map<Integer, Integer>>();
            int idx = 1;
            int h = height();
            int w = width();
            for (int r = 0; r < h; r++) {
