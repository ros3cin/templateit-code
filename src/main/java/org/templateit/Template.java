...
public abstract class Template {
    ...
    protected final List<Parameter> parameters = new java.util.ArrayList<Parameter>();

    private final Map<String, Parameter> parametersByName = new org.apache.commons.collections4.map.HashedMap<String, Parameter>();

    private final Map<Integer, Map<Integer, Parameter>> paramsByRowCol = new java.util.LinkedHashMap<Integer, Map<Integer, Parameter>>();
